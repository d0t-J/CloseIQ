...
def process_document(file_path: str) -> str:
    ...
    if ext == '.pdf':
        ...
        raise ValueError(f"Unsupported file type: {ext}. Only {supported} files allowed.")
...
def force_delete_directory(path: str, max_retries: int = 5):
    ...
    print(f"💡 Directory will remain but is empty of data. You can manually delete it later.")
    return False
