    ...
    return (
        ...
        <header className="relative z-10 border-b border-[#1f1f1f] backdrop-blur-sm bg-[#0b0b0b]/80">
            ...
            <div className="flex items-center gap-4">
                ...
                />
                <span className="font-semibold text-lg">eNZeTi Coach</span>
            ...
            >
              ...
              <span>Training Docs</span>
                ...
                {!isRecording ? (
                <button onClick={startRecording} className="flex items-center gap-2 px-5 py-2 rounded-lg bg-[#d4af37] text-black font-semibold hover:bg-[#c9a227] transition-all active:scale-95">
                ...
                <button onClick={stopRecording} className="flex items-center gap-2 px-5 py-2 rounded-lg border border-red-500 text-red-400 hover:bg-red-500/10 transition-all active:scale-95">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <main className="relative z-10 max-w-7xl mx-auto px-6 py-8 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-xs text-slate-400">Capturing prospect audio</p>
                </div>
                </div>
                ...
                <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                    <span className="text-sm font-medium text-white">Your Microphone</span>
                    <div className="flex gap-0.5">
                        {[...Array(3)].map((_, i) => (
                        <div
                            key={i}
                    ...
                    <p className="text-xs text-slate-400">Recording your voice</p>
                </div>
                </div>
            </div>
            )}
            ...
            <div className="bg-[#141414] border border-[#262626] rounded-2xl overflow-hidden">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div>
                        <h2 className="font-semibold text-blue-400 text-sm tracking-wide">PROSPECT</h2>
                        <p className="text-xs text-slate-500">System Audio</p>
                    </div>
                    </div>
                    {prospectTranscript && (
                    <span className="text-xs text-slate-500 font-mono">
            ...
            <div className="bg-[#141414] border border-[#262626] rounded-2xl overflow-hidden">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div>
                        <h2 className="font-semibold text-emerald-400 text-sm tracking-wide">CLOSER</h2>
                        <p className="text-xs text-slate-500">Your Microphone</p>
                    </div>
                    </div>
                    {closerTranscript && (
                    <span className="text-xs text-slate-500 font-mono">
            ...
            <div className="flex justify-end">
                <button onClick={clearTranscripts} className="flex items-center gap-2 text-sm text-slate-400 hover:text-white transition-colors px-4 py-2 rounded-lg hover:bg-[#1a1a1a]">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <div>
                    <h2 className="text-lg font-semibold text-white">AI Sales Coach</h2>
                    <p className="text-xs text-slate-400 mt-0.5">
                    Press{" "}
                    <kbd className="px-2 py-0.5 bg-[#262626] rounded text-[#d4af37] font-mono text-xs border border-[#333]">
                        Ctrl+J
                    </kbd>{" "}
                    during a live call to receive real-time coaching
                    </p>
                </div>
                </div>
                <button
            ...
            {isLoadingAI && (
                ...
                <div className="text-center">
                    <svg className="w-10 h-10 text-[#d4af37] animate-spin mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                    </svg>
                    <p className="text-sm text-slate-400 font-medium">
                    Analyzing conversation and generating suggestions...
                    </p>
                </div>
                </div>
            )}
            ...
            {!isLoadingAI && !aiSuggestion && (
                ...
                <svg className="w-14 h-14 text-[#666] mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                </svg>
                <p className="text-slate-400 font-medium mb-2">No AI suggestions yet</p>
                <p className="text-sm text-slate-500">
                    Start recording and press <kbd className="px-2 py-0.5 bg-[#262626] rounded text-[#d4af37] font-mono text-xs">Ctrl+J</kbd> to get real-time coaching
                </p>
                </div>
            )}
            ...
            {!isLoadingAI && aiSuggestion && (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <h3 className="font-semibold text-white text-sm">What to Say</h3>
                    </div>
                    ...
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <h3 className="font-semibold text-white text-sm">Why It Works</h3>
                    </div>
                    <p className="text-sm text-slate-300 leading-relaxed">
                    ...
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <h3 className="font-semibold text-white text-sm">Next Move</h3>
                    </div>
                    <p className="text-sm text-slate-300 leading-relaxed">
