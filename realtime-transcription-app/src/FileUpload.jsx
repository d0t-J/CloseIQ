...
export function KnowledgeBasePopup({
    open,
    onClose,
    session,
    backendUrl,
                ...
                <div className="border-b border-[#262626] p-6 flex items-start justify-between">
                    <div>
                        ...
                        <p className="text-[#888] text-sm">
                            Enhance AI intelligence by uploading specific sales
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                <div className="flex gap-1.5">
                                    {Array.from({ length: maxFiles }).map(
                                        (_, i) => (
                                            <div
                                                key={i}
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="space-y-4">
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-[#888] leading-relaxed">
                                            Limit of 3 core training documents
                                            per active profile.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-[#888] leading-relaxed">
                                            Neural embeddings are generated
                                            instantly for RAG retrieval.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-[#888] leading-relaxed">
                                            Documents are siloed and used only
                                            for your specific coaching.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="bg-gradient-to-br from-[#d4af37]/10 to-transparent border border-[#d4af37]/20 rounded-xl p-4">
                            ...
                            <p className="text-xs text-[#ccc] leading-relaxed italic">
                                "Focus on uploading transcripts of your most
                                successful closing calls to teach the AI your
                                unique tone."
                            </p>
                        </div>
...
export default function App() {
    ...
    const mockLogo =
        "https://via.placeholder.com/120x120/d4af37/000000?text=CloseIQ";
